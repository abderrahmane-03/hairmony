...
export default function PaymentSuccessPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(`/api/payment/details?sessionId=${sessionId}`)
              ...
              <div className="flex flex-col items-center space-y-6 pb-6">
                ...
                <div className="relative">
                  <div className="w-64 h-64 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
                    <Check className="h-32 w-32 text-green-500 dark:text-green-400" />
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-blue-50 dark:bg-gray-700 rounded-xl p-6 border-l-4 border-blue-500 shadow-md">
                  <h2 className="text-lg font-bold text-gray-800 dark:text-white mb-3 flex items-center">
                    <span className="mr-2">What is Next?</span>
